...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/still-wind-9474)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/still-wind-9474
```

A live public deployment of this template is available at [https://still-wind-9474.templates.workers.dev](https://still-wind-9474.templates.workers.dev)
